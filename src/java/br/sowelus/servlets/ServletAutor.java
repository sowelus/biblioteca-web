...
import br.sowelus.dao.AutorDAO;
...
public class ServletAutor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acao == null){
            ...
            Integer codigo = Integer.parseInt(request.getParameter("id"));
            Autor obj = dao.localizar(codigo);
            if (obj != null){
                dao.remover(obj);                
            }
            tela = "listar.jsp";
            ...
            dao.getObjetoSelecionado().setNomeArtistico(request.getParameter("nome_artistico"));
            dao.getObjetoSelecionado().setPais(request.getParameter("pais"));
